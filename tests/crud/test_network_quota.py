...
from fedreg.quota.schemas import NetworkQuotaCreate, NetworkQuotaUpdate
...
class CaseQuota:
    @case(tags="create")
    def case_network_quota_create(self) -> NetworkQuotaCreate:
        return NetworkQuotaCreate(name=random_lower_string(), uuid=uuid4())

    @case(tags="update")
    def case_network_update(self) -> NetworkQuotaUpdate:
        return NetworkQuotaUpdate(name=random_lower_string(), uuid=uuid4())
