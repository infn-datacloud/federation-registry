...
def choose_block_storage_schema(
    ...
    return choose_out_schema(
        ...
        short=short,
        with_conn=with_conn,
        read_private_schema=BlockStorageService,
...
def choose_compute_schema(
    ...
    return choose_out_schema(
        ...
        short=short,
        with_conn=with_conn,
        read_private_schema=ComputeService,
...
def choose_identity_schema(
    ...
    return choose_out_schema(
        ...
        short=short,
        with_conn=with_conn,
        read_private_schema=IdentityService,
...
def choose_network_schema(
    ...
    return choose_out_schema(
        ...
        short=short,
        with_conn=with_conn,
        read_private_schema=NetworkService,
...
def choose_object_store_schema(
    ...
    return choose_out_schema(
        ...
        short=short,
        with_conn=with_conn,
        read_private_schema=ObjectStoreService,
